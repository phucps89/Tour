...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Tour</b> Suggestion</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('assets/media/images/avatar_1.png')}}" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{$user->first_name.' '.$user->last_name}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="{{asset('assets/media/images/avatar_1.png')}}" class="img-circle" alt="User Image">
                                <p>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('logout')}}" onclick="return confirm('Do you want to log out?')" class="btn btn-default btn-flat">Log out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('dashboard/plugins/jquery-ui.min.js')}}"></script>
...
<!-- daterangepicker -->
<script src="{{asset('dashboard/plugins/moment.min.js')}}"></script>
