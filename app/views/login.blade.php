...
<head>
    ...
    <style>
        ...
        body{
            height: 100%;
            background: url(http://wallpapers55.com/wp-content/uploads/2013/12/World-and-travel-02.jpg)
    ...
    <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <form id="signupform" class="form-horizontal" method="post" role="form" action="{{route('register')}}">

                    @if(Session::has('error'))
                    <div id="signupalert" class="alert alert-danger">
                        <p><b>Error</b>: {{Session::get('error')}}</p>
                    </div>
                    @endif
